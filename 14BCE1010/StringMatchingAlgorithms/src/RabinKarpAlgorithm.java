...
public class RabinKarpAlgorithm {
	...
	public static int patternSearch(char[] text,char[] pattern)
	{
	 ...
	 public static long recalculateHash(char[] str,int oldIndex, int newIndex,long oldHash, int patternLen) {
	    ...
	    public static boolean checkEqual(char str1[],int start1,int end1, char str2[],int start2,int end2){
	...
	public static void main(String[] args) {
       ...
       int i=patternSearch("aaaabbbbbcccccdddd".toCharArray(),"aaaab".toCharArray());
